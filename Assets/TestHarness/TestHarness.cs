...
public class FakeBombInfo : MonoBehaviour
{
    ...
    public List<string> GetSolvableIds()
    {
        List<string> moduleList = new List<string>();
        foreach (KeyValuePair<KMBombModule, bool> m in modules)
        {
    ...
    public List<string> GetSolvedIds()
    {
        List<string> moduleList = new List<string>();
        foreach (KeyValuePair<KMBombModule, bool> m in modules)
        {
...
public class TestHarness : MonoBehaviour
{
    ...
    void Handlers(KMBombInfo component)
    {
        ...
        component.ModuleIDsHandler += new KMBombInfo.GetModuleIDsHandler(fakeInfo.GetIds);
        component.SolvableModuleIDsHandler += new KMBombInfo.GetSolvableModuleIDsHandler(fakeInfo.GetSolvableIds);
        component.SolvedModuleIDsHandler += new KMBombInfo.GetSolvedModuleIDsHandler(fakeInfo.GetSolvedIds);
